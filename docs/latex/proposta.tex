...
\preambulo{Proposta para Trabalho de Conclusão de Curso do Curso de Bacharelado em Sistemas de Informação da Universidade Estadual Paulista ``Júlio de Mesquita Filho'', Faculdade de Ciências, Campus Bauru.}
...
\input{chapters/solucoes-existentes-e-objetivos}
\input{chapters/detalhamento}
\input{chapters/descricao}
